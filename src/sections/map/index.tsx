...
import { useUpdateZone, useDeleteZone } from "@/hooks/zone/zone";
...
export default function MapIndex() {
 ...
 console.log("zoneNodes", zoneNodes);
    ...
    <div>
      ...
      {!loading && !error && (
        <>
          ...
          >
            <ZoneForm zoneForm={zoneForm} onChange={handleZoneChange} />
          </Drawer>
        </>
      )}
